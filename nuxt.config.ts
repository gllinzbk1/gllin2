...
export default defineNuxtConfig({
  ...
  pinia: {
    autoImports: ['defineStore', 'acceptHMRUpdate', 'storeToRefs', 'mapStores', 'getActivePinia','findStoreById'],
  },
  // routeRules:{
  ...
  build: {
    transpile: [/blueblocksui/,'useFetch'],  //是一个正则
    exclude: [/useFetch/]
