...
//export async function useProductListInfo(category,storeName) {


   //const { data:data } = await useFetch('/api/list?url='+category+'&page=1',{responseType:'json'})  
  // const pdata = JSON.parse(data.value)
  // console.log('apiDataLength',useSize(pdata),pdata)

 // const productStore = registerStore(storeName)().init(data.value); 
